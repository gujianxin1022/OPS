  ...
  <div class="teacher-filter-key-warp">
    ...
    >
      <el-select
        ...
        class="search-type"
      >
        <el-option :label="$t('按姓名')" value="1"></el-option>
        <el-option :label="$t('按ID')" value="2"></el-option>
        <el-option :label="$t('按用户名')" value="4"></el-option>
        <el-option :label="$t('按昵称')" value="3"></el-option>
      </el-select>
    </el-input>
  </div>
</template>

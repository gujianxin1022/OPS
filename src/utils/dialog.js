...
export function openModal({
  modalProps /* el-dialog props */,
  componentProps /* component pros */,
  component,
  okCallback /* submit callback */,
}) {
  FormDialog(modalProps, h(component, { props: { ...componentProps } }))
    .forConfirm(async (_, next) => {
      const handleOk =
        component.setup?.()?.handleOk ?? component.methods?.handleOk;
      await handleOk?.();
      next();
      okCallback?.();
    })

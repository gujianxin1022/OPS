    ...
    <div class="table-wrap">
      ...
      >
        ...
        >
          ...
          <!-- <template slot-scope="scope">
            <span>{{ scope.row.tutorUserId }}</span>
          </template> -->
        </el-table-column>
        <el-table-column
          align="center"
...
export default {
  ...
  watch: {
    currentDate (newData) {
      // console.log("fullTimeClassPayEn-----------", this.currentDate);
      this.screenData.pageNum = 1;
      this.getTutorVirtualList();
    },
    subjectType() {
      // console.log("fullTimeClassPayEn-----------", this.subjectType);
      this.screenData.pageNum = 1;
      this.getTutorVirtualList();
    }
  },
  methods: {
    ...
    goDetail (scopeRow) {    
      this.$router.push(`/tutorManagement/classPayDetailEn?tutorId=${scopeRow.tutorUserId}&time=${this.getTheDateOfYYMM()}&tutorName=${scopeRow.tutorRealName}`)
    },
    getCurrentPage (page) {

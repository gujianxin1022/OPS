<template>
  <div class="part-time-detail-wrap">
    <div class="table-wrap">
      <el-collapse>
        <el-collapse-item :title="$t('出席扣款')" v-if="tableData.attendFeeList && tableData.attendFeeList.length > 0">
          <!-------------- 出席扣款 --------------------->
          <el-table
            :border="false"
            :data="tableData.attendFeeList"
            v-loading="loading"
            tooltip-effect="dark"
            fit
        ...
        <el-collapse-item :title="$t('请假扣款')" v-if="tableData.leaveFeeList && tableData.leaveFeeList.length > 0">
          <!-------------- 请假扣款 --------------------->
          <el-table
            :border="false"
            :data="tableData.leaveFeeList"
            v-loading="loading"
            tooltip-effect="dark"
            fit
            show-overflow-tooltip="true"
          ...
          >
            ...
            >
              <template slot-scope="scope">
                <span>{{ DateTimeUtils.dateClockTime(scope.row.leaveTime) }}</span>
              </template>
            </el-table-column>
        ...
        <el-collapse-item :title="$t('人工扣款')" v-if="tableData.artificialFeeList && tableData.artificialFeeList.length > 0">
          <!-------------- 人工扣款 --------------------->
          <el-table
            :border="false"
        ...
        <el-collapse-item :title="$t('其他扣款')" v-if="tableData.otherFeeList && tableData.otherFeeList.length > 0">
          <!-------------- 扣款 --------------------->
          <el-table
            :border="false"
        ...
        <el-collapse-item :title="$t('课堂扣款')" v-if="tableData.courseFeeList && tableData.courseFeeList.length > 0">
          <el-table
            :border="false"
...
export default {
  name: 'classPayDeductionDetailEn',
  props: {
    tutorId: {
      type: String,
      required: true
  ...
  methods: {
    ...
    getTableData () {
      ...
      this.$Api.tutorManagement.getEnTutorDeductionDetail(
        params
      )
        .then(({ status, data }) => {

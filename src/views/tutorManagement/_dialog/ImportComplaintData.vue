...
export default {
  ...
  setup(props, { root, refs, emit }) {
    ...
    const upload = (e) => {
      ...
      axios({
        method: "post",
        url: `${process.env.VUE_APP_BASE_API}/opsapi/teachermanager/teacher-manage/user/tutor/complaint/import/file`,
        data,
        responseType: "blob",
        headers: {
    ...
    const handleDownload = () => {
      location.href =
        "https://s3.us-west-1.amazonaws.com/media.pplingo.com/templates/TutorComplaintTemplate_v1.xlsx";
    };

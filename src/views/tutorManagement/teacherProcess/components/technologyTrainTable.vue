<template>
  <div class="technology-train-wrap">
    <div class="search-wrap">
      ...
      <el-select
        clearable
        filterable
        v-model="screenData.skillUserId"
        :placeholder="
          $t('my-home-Select') + (currentLang == 'en' ? ' ' : '技术培训师')
        "
      >
        <el-option
    ...
    <div class="table-wrap">
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <span>{{
              DateTimeUtils.dateClockTime(scope.row.skillTime).split(" ")[0]
            }}</span>
          </template>
        </el-table-column>
        <el-table-column
      ...
      >
        <div>
          <el-form
            ...
            :rules="examineRules"
            ref="examineForm"
            :label-width="currentLang === 'en' ? '150px' : '110px'"
            class="examine-form"
          >
            ...
            <el-form-item
              ...
              prop="isSkill"
            >
              <el-radio-group v-model="examineForm.isSkill">
                <el-radio :label="1">{{ $t("完成技术培训") }}</el-radio>
                <el-radio :label="0">{{ $t("未完成技术培训") }}</el-radio>
              </el-radio-group>
            </el-form-item>
            <el-form-item
              v-if="examineForm.examineStatus == 2"
            ...
            >
              <el-input
                ...
                "
                v-model="examineForm.skillRemark"
              >
              </el-input>
            </el-form-item>
            <el-form-item
...
export default {
  ...
  methods: {
    ...
    getTableData() {
      ...
      let { pageSize, pageNum, skillUserId, dateType } =
        this.screenData;
      let params = {
        skillUserId,
        dateType,
      ...
      this.$Api.tutorManagement
        .getTeacherProcessList(4, pageNum, pageSize, params)
        .then(({ status, data }) => {
          if (status == 200 && data.code == 200) {

...
async function saveUnitKnowledge(params) {
    return $post('/opsapi/unit/report/knowledge/pointsV2',params);
}
...
async function updateUnitKnowledge(params) {
    return $post('/opsapi/unit/report/release/knowledge/pointsV2',params);
}
...
async function saveUnitSkill(params) {
    return $post('/opsapi/unit/report/skillV2',params);
}
...
async function updateUnitSkill(params) {
    return $post('/opsapi/unit/report/release/skillV2',params);
}
...
async function saveOrUpdateCommunication(params) {
    return $post('/opsapi/report/saveOrUpdatePerformances',params);
}
         ...
         items: {
           ...
           properties: {
             ...
             knowledgeDimension: {
               type: 'void',
               'x-component': 'ArrayTable.Column',
               'x-component-props': {width: 250,  title: config.knowledgeDimension ,
                 "style": {
                       "margin": "50px 0px 0px 0px"
                 }
                },
